...
const MINES = {
  MON_200: {
    ...
    DESCRIPTION_MINE:
      'Встановлюється на ґрунт чи кріпиться до предметів, маскується рослинністю. '
        + 'Вибух відбувається завдяки пульта управління чи при зачіпанні підривного датчика.',
  ...
  TM_62: {
    ...
    DESCRIPTION_MINE:
      'Частіше закопана у ґрунт та замаскована рослинністю, може бути '
        ...
        + 'Вибух відбувається при наїзді на верхню кришки міни.',
    MINE_AVAILABLE: false,
  },
  PFM_1: {
    MINE_ID: 'PFM_1',
    ...
    DESCRIPTION_MINE:
      'Буває зеленого та коричневого кольору. Для мінування застосовують '
        + 'як наземні, так і повітряні засоби. Вибух відбувається в момент наступання ногою на датчик цілі.'
  ...
  MON_50: {
    ...
    DESCRIPTION_MINE:
      'Міну встановлюють на ґрунт або кріплять до предметів '
  ...
  PMN_2: {
    ...
    DESCRIPTION_MINE:
      'Міна може встановлюватися у ґрунт або на поверхню землі. '
  ...
  OZM_72: {
    ...
    DISTANCE_MINE: 'Радіус ураження: 25 м',
    DESCRIPTION_MINE:
      'Встановлюється у ґрунт. Має датчик цілі у вигляді розтяжки. '
        + 'При спрацьовуванні: бойова частина виштовхується на висоту 0,6-0,8 м, після чого відбувається вибух.',
    MINE_AVAILABLE: false,
  },
  PTM_3: {
    MINE_ID: 'PTM_3',
  ...
  RGO: {
    ...
    WEIGHT_MINE: 'Спрацювання: зіткнення гранати із твердою поверхнею; '
        + 'самоліквідація через 3,2 - 4,2 с після відпускання запобіжного важеля.',
  ...
  N210: {
    ...
    WEIGHT_MINE: 'Самоліквідація: через 110 с(інколи можуть здетонувати не одразу)',
  ...
  VOG_25: {
    ...
    WEIGHT_MINE: 'Самоліквідація: понад 14 с (інколи можуть не здетонувати одразу)',
    DISTANCE_MINE: 'Радіус ураження: 25 м',
    DESCRIPTION_MINE:
